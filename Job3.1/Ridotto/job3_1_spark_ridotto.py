...
df = spark.read.csv("/user/hadoop/job3.1/input_ridotto/dataset_job_3_1_ridotto.csv", header=True, inferSchema=True)
...
result.coalesce(1).write.csv("/user/hadoop/job3.1/output_spark_job3_1_ridotto", sep='\t', header=False)
