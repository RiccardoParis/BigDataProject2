...
) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE LOCATION 's3://nome_bucket_s3/input/job3.2/' TBLPROPERTIES ("skip.header.line.count"="1");
...
-- =========================================================
INSERT OVERWRITE DIRECTORY 's3://nome_bucket_s3/output_hive2' ROW FORMAT DELIMITED FIELDS TERMINATED BY '\t'
SELECT 
    f.origin, f.month,
