...
if __name__ == "__main__":
    ...
    lines = sc.textFile("/user/hadoop/job3.2/input_ridotto/dataset_job_3_2_ridotto.csv")
    ...
    # Salva
    sorted_rdd.map(format_row).saveAsTextFile("/user/hadoop/job3.2/output_spark_ridotto")
